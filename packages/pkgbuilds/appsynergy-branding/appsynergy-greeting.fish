...
# Suppress default / vendor fish_greeting (e.g. CachyOS fastfetch) for this shell.
# config.fish sourced later may redefine fish_greeting — see note in package README.
