...
```bash
gwenview desktop/brand-review/candidates-all/*1920x1200*
# or
dolphin desktop/brand-review/candidates-all/
```
...
```bash
gwenview desktop/brand-review/icons/start-menu/preview-on-dark-panel.png
```
